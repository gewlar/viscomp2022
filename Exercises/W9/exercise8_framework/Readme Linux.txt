...
copying the files from the folder "OpenGL2.1" to your main directory. Check the
setup FAQ on the course GitHub repository in case of problems.


Credits
------
The helicopter model used in this exercise was taken from from http://www.turbosquid.com/