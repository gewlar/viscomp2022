...
public:
	...
	Matrix(const Vector &v0,
		   const Vector &v1,
		   const Vector &v2,
		   const Vector &v3,
		   bool isColumnVectors = false)
	{
	...
	static const Matrix createOrthoMatrix( 
										float left, 
										float right,
										float bottom,
										float top,
	...
	static const Matrix createPerspectiveMatrix( 
										float fovy, 
										float aspect,
										float zNear,
										float zFar
	...
	static const Matrix createLookAtMatrix(
										const Vector& eyePos, 
										const Vector& lookAtPos,
										const Vector& upVec
										);
