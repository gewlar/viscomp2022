...
void Material::loadShader(GLShader & material_Shader)
{
	...
	if(binding.size() == 0) {
		...
		binding["texoord" ] = DEFAULT_VERTEX_TEX_BINDING;
...
// Base Material
//////////////////////////////////////////////////////////////////////////
ColoredDiffuseMaterial::ColoredDiffuseMaterial()
	: Material("ColoredDiffuse")
{
	GLShader shader;
	shader.loadFromFile(MAIN_DIR "shaders/diffusecolor.glslv", MAIN_DIR "shaders/diffusecolor.glslf");
...
{
	TRY_TO_SET_UNIFORM("in_color", m_color);
